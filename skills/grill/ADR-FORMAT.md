...
Check the project's `CLAUDE.md` for the canonical ADR path. Common locations:
- `docs/architecture/system_adr/` (numbered `0001-slug.md`, `0002-slug.md`, …)
- `docs/adr/`

If no project path is specified, create `docs/adr/` lazily on the first ADR.
